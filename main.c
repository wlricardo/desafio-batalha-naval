...
// FUNÇÕES AUXILIARES
/* Inicializar tabuleiro : preenche o tabuleiro com 0 (água) */
...
/* Imprimir tabuleiro : mostra o tabuleiro e navios eventualmente inseridos */
...
int main()
{
    ...
    inserir_navio(tab, 1, 4, 3, 'H');                                           // Insere um navio horizontal de tamanho 3 na linha 2, coluna 3
    inserir_navio(tab, 2, 4, 3, 'V');                                           // Insere um navio vertical de tamanho 3 na linha 5, coluna 6
